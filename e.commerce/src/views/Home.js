    ...
    return (
        <div>
            <div className="container-fluid  ">
                <div className="mb-5 mt-5 mx-5 col-lg-10 d-flex justify-content-between align-content-center ">
                   <div className="col-md-5  ">
                        <img className="bg-dark img-fluid" src={img5} alt=""  />
                    
                    </div>     
                   <div className="mx-5 col-lg-6 col-md-7 col-sm-8">
                ...
                <div className="mt-5 ">
                    <div className=" d-flex col-lg-10 mx-5">
                        <div className="col-lg-6 col-sm-6">
                         ...
                         <div className=" col-sm-3 d-flex ">
                            ...
                            <img className="mx-2 img-fluid " src={img3} alt="" />
                         </div>   
                     </div>
